...
public class userDAO 
{
    ...
    public boolean update(user users) throws SQLException {
		...
		preparedStatement.setInt(10, users.getCash_bal());		
		preparedStatement.setInt(11, users.getPPS_bal());
    ...
    public user saveUser(user User) throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            savedUser.setFirstName(resultSet.getString("firstName"));
            savedUser.setLastName(resultSet.getString("lastName"));
            savedUser.setPassword(resultSet.getString("password"));
            savedUser.setBirthday(resultSet.getString("birthday"));
            savedUser.setAddress_street_num(resultSet.getString("address_street_num"));
            savedUser.setAddress_street(resultSet.getString("address_street"));
            savedUser.setAddress_city(resultSet.getString("address_city"));
            savedUser.setAddress_state(resultSet.getString("address_state"));
            savedUser.setAddress_zip_code(resultSet.getString("address_zip_code"));
            savedUser.setCash_bal(resultSet.getInt("cash_bal"));
            savedUser.setPPS_bal(resultSet.getInt("PPS_bal"));
        }
    ...
    public void init() throws SQLException, FileNotFoundException, IOException{
        ...
        String[] TUPLES = {("insert into User(email, firstName, lastName, password, birthday, address_street_num, address_street, address_city, address_state, address_zip_code, cash_bal, PPS_bal)"+
        			"values ('susie@gmail.com', 'Susie ', 'Guzman', 'susie1234', '2000-06-27', '1234', 'whatever street', 'detroit', 'MI', '48202','1000', '0'),"+
			    			...
			    			"('root', 'default', 'default','pass1234', '0000-10-10', '0000', 'Default', 'Default', '0', '00000','1000','1000000000');")
			    			};
